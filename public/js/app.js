...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css":
/*!***************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css ***!
  \***************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css":
/*!*******************************************************************************!*\
  !*** ./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css ***!
  \*******************************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../css-loader??ref--5-1!../../postcss-loader/src??ref--5-2!./vue-simple-context-menu.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_vue_init_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/vue_init.js */ "./resources/js/assets/vue_init.js");


/***/ }),

/***/ "./resources/js/assets/vue_init.js":
/*!*****************************************!*\
  !*** ./resources/js/assets/vue_init.js ***!
  \*****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_simple_context_menu_dist_vue_simple_context_menu_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-simple-context-menu/dist/vue-simple-context-menu.css */ "./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.css");
/* harmony import */ var vue_simple_context_menu_dist_vue_simple_context_menu_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue_simple_context_menu_dist_vue_simple_context_menu_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vue_simple_context_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-simple-context-menu */ "./node_modules/vue-simple-context-menu/dist/vue-simple-context-menu.esm.js");
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Import components
...
var vueApp = new Vue({
  el: "#app",
  components: {
    'vue-simple-context-menu': vue_simple_context_menu__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  mounted: function mounted() {
    this.sort_notes();
    this.sort_notebooks();
    this.load_note_from_hash(); // On hash change
  ...
  methods: {
     ...
     *
     */
    editor_init: function editor_init() {
      console.log('editor init.'); // let editor = tinymce.get('editor')
      // Set editor to disabled if note is deleted.

      this.toggle_editor_disabled(this.getActiveNote()); // Update content backend on change.

      var self = this; // editor.on('keyup change redo undo', function(e) {
     ...
     *
     */
    sort_notes: function sort_notes() {
     ...
     *
     */
    sort_notebooks: function sort_notebooks() {
      // Sort by 'sort_order'
     ...
     *
     */
    getActiveNote: function getActiveNote() {
     ...
     *
     */
    getNoteByID: function getNoteByID(note_id) {
     ...
     *
     */
    getNotebookByID: function getNotebookByID(notebook_id) {
      return this.notebooks.find(function (notebook) {
     ...
     *
     */
    getViewByLabel: function getViewByLabel(label) {
      return this.views.find(function (view) {
        return view && view.label === label;
      });
    },
     ...
     *
     */
    get_note_class: function get_note_class(note) {
      return {
     ...
     *
     */
    get_notebook_class: function get_notebook_class(notebook) {
      return {
        'notebook_link': true,
     ...
     *
     */
    get_view_class: function get_view_class(view) {
      return {
     ...
     *
     */
    view_note: function view_note(note) {
      this.active_note_id = note.id; // Set active view/notebook
      ...
      window.location.hash = '#/note/' + note.id; // if (typeof tinymce !== 'undefined') {
     ...
     *
     */
    toggle_editor_disabled: function toggle_editor_disabled(note) {
      // Disable editor (if note is deleted)
      var allow_edit_body = note.deleted_at ? 'false' : 'true'; // if (tinymce.get('editor') === null) {
     ...
     *
     */
    delete_note: function delete_note(_delete_note) {
      var _this = this;
      ...
      axios.post('/note/' + _delete_note.id + '/delete').then(function (response) {
        _this.waiting_for_ajax = false;

        _this.view_note_after_deletion(_delete_note);

        _delete_note.deleted_at = response.data.deleted_at; // this.toggle_editor_disabled(delete_note)
      });
    },
     ...
     *
     */
    view_note_after_deletion: function view_note_after_deletion(delete_note) {
      var found = false;

      for (var note_id in this.notes) {
        var note = this.notes[note_id];
     ...
     *
     */
    restore_note: function restore_note(note) {
      var _this2 = this;
      ...
      this.waiting_for_ajax = true;
      axios.post('/note/' + note.id + '/restore').then(function (response) {
        _this2.waiting_for_ajax = false; // If note's notebook is deleted, then find a new notebook.

        if (!_this2.getNotebookByID(note.notebook_id)) {
          // Set notebook_id (TODO: Do it backend.)
          _this2.set_notebook_id_on_note(note, _this2.notebooks[0].id);
        } // Restore in vue.
     ...
     *
     */
    perm_delete_note: function perm_delete_note(note) {
      var _this3 = this;
      ...
      this.waiting_for_ajax = true;
      axios.post('/note/' + note.id + '/perm_delete').then(function (response) {
        _this3.waiting_for_ajax = false; // Remove note from array.

        var note_index = _this3.notes.indexOf(note);

        _this3.notes.splice(note_index, 1);

        _this3.view_note_after_deletion(note); // This should not be needed anymore.
        // this.toggle_editor_disabled(note)

      });
    },
    set_notebook_id_on_note: function set_notebook_id_on_note(note, notebook_id) {
      var _this4 = this;

      this.waiting_for_ajax = true;
      axios.post('/note/' + note.id + '/set_notebook', {
        notebook_id: notebook_id
      }).then(function (response) {
        _this4.waiting_for_ajax = false;
     ...
     *
     */
    create_note: function create_note() {
      var _this5 = this;
      ...
      axios.post('/note/create', {
        ...
        _this5.waiting_for_ajax = false;
        var note = response.data.note;
        note.deleted_at = null;

        _this5.notes.push(note);

        _this5.sort_notes();

        _this5.view_note(note);

        _this5.$refs.note_title.focus();
      });
    },
     ...
     *
     */
    create_notebook: function create_notebook() {
      var _this6 = this;

      this.waiting_for_ajax = true;
      axios.post('/notebook/create').then(function (response) {
        _this6.waiting_for_ajax = false;
        var notebook = response.data.notebook;

        _this6.notebooks.push(notebook); // this.sort_notes()
        // this.view_note(note)
     ...
     *
     */
    view_notebook: function view_notebook(notebook) {
     ...
     *
     */
    toggle_star: function toggle_star(note) {
      var _this7 = this;

      this.waiting_for_ajax = true;
      axios.post('/note/' + note.id + '/toggle_star').then(function (response) {
        _this7.waiting_for_ajax = false;
     ...
     *
     */
    set_content: function set_content(note, content) {
      var _this8 = this;
     ...
     *
     */
    set_title: function set_title(note) {
      var _this9 = this;
      ...
      document.title = this.get_note_title(note) + ' | Dopenote'; // Update Backend

      this.waiting_for_ajax = true;
      axios.post('/note/' + note.id + '/set_title', {
        title: note.title
      }).then(function (response) {
        _this9.waiting_for_ajax = false;
        note.updated_at = response.data.note.updated_at;
     ...
     *
     */
    get_note_title: function get_note_title(note) {
      var prepend = '';

      if (this.active_view_label) {
        // View: Starred / trash.
        // Prepend the notebook title (if not deleted).
        var notebook = this.getNotebookByID(note.notebook_id);
     ...
     *
     */
    getStarClass: function getStarClass(note) {
      return {
     ...
     *
     */
    load_note_from_hash: function load_note_from_hash() {
     ...
     *
     */
    render_note_in_list: function render_note_in_list(note) {
      if (this.active_view_label) {
        // View
        if (this.active_view_label == 'starred') {
          // Starred
     ...
     *
     */
    notebook_context_menu_show: function notebook_context_menu_show(event, item) {
     ...
     *
     */
    notebook_context_menu_action: function notebook_context_menu_action(event) {
     ...
     *
     */
    render_rename_notebook: function render_rename_notebook(notebook) {
      var _this10 = this;

      var new_title = prompt("Rename notebook", notebook.title);
      notebook.title = new_title; // Update backend

      this.waiting_for_ajax = true;
      axios.post('/notebook/' + notebook.id + '/rename', {
        title: new_title
      }).then(function (response) {
        _this10.waiting_for_ajax = false;
      });
    },
     ...
     *
     */
    confirm_delete_notebook: function confirm_delete_notebook(notebook) {
      var _this11 = this;
      ...
      this.waiting_for_ajax = true;
      axios.post('/notebook/' + notebook.id + '/delete').then(function (response) {
        _this11.waiting_for_ajax = false; // Delete notes in this notebook.
        // They are already deleted in backend.

        _this11.notes.forEach(function (note) {
        ...
        var index = _this11.notebooks.findIndex(function (nb) {
          return nb.id === notebook.id;
        });

        _this11.notebooks.splice(index, 1);
      });
    },
     ...
     *
     */
    notebooks_draggable_change: function notebooks_draggable_change(event) {
      var _this12 = this;

      this.waiting_for_ajax = true;
      axios.post('/notebook/update_sort_order', {
        old_index: event.oldIndex,
        new_index: event.newIndex
      }).then(function (response) {
        _this12.waiting_for_ajax = false;
      });
    }
  }
...
module.exports = __webpack_require__(/*! P:\code\dopenote\resources\js\app.js */"./resources/js/app.js");
